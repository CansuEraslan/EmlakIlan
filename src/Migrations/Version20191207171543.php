 ...
 */
final class Version20191207171543 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE house ADD m2 INT DEFAULT NULL');
    }
}
